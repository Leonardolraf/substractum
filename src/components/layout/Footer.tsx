        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-green-200">
              ...
              <li><a href="/help-center" className="hover:text-white transition-colors">Suporte</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-green-200 mb-4">
              ...
              <li>Quadra 40 Lojas 20/22 - Setor Central Comercial - Gama DF, Gama 72.405-400</li>
            </ul>
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="https://api.whatsapp.com/send/?phone=5561983472867&text&type=phone_number&app_absent=0"
                target="_blank"
                rel="noopener noreferrer"
                className="text-green-200 hover:text-white transition-colors"
              >
